...
/**
 * Provides a form for deleting a user_class entity.
 */
class UserClassDeleteForm extends ContentEntityConfirmFormBase {
  ...
  public function getCancelUrl() {
    return new Url('entity.user_class.collection');
  }
  ...
  public function submitForm(array &$form, FormStateInterface $form_state) {
    ...
    $this->logger('user_class')->notice('@type: deleted %title.',
      [
